...
module.exports = function(app) {
    ...
    app.post('/Financing/LcRed/getRedList', read('../data/red_list.json'));
    app.post('/Financing/LcTyj/tyjProducts', read('../data/new_list.json'));
    app.post('/Financing/LcRed/investRedList', read('../data/invest_red_list.json'));
